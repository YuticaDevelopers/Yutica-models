...
type DailyUsage struct {
	...
	UsageDate  time.Time          `gorm:"index" json:"usage_date"`            // the day of measurement
	VolumeUsed float64            `json:"volume_used"`                        // e.g., liters or kWh
	Estimated  bool               `json:"estimated"`                          // true if actual reading was unavailable
